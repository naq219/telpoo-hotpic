...
public class CopyOfExLvAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		...
		//final String childText = ((BaseObject) getChild(groupPosition, childPosition)).get(AlbulmOj.NAME);
		String childText = ((BaseObject) getChild(groupPosition, childPosition)).get(MenuOj.NAME);
		Log.d("testchild text", childText);
		if (convertView == null) {
			LayoutInflater infalInflater = (LayoutInflater) this._context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			convertView = infalInflater.inflate(R.layout.item_child_exp, null);
		}

		TextView txtListChild = (TextView) convertView.findViewById(R.id.tv);
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			LayoutInflater infalInflater = (LayoutInflater) this._context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			convertView = infalInflater.inflate(R.layout.item_header_exp, null);
		}

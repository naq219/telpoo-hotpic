...
public class SlidingFragmentActivity extends BaseFmActivity implements
		SlidingActivityBase {

	

	public SlidingFragmentActivity(String[] TabIds, int resource_home, String toastAskExit) {
